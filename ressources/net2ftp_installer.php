...
elseif ($_GET["security_code"] != "xrle05ve7xwx37cbwez" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_kr66d";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=xrle05ve7xwx37cbwez" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ppiscine.esy.es"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u625731772"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html/projet_Piscine/ressources"></td></tr>
</table>
