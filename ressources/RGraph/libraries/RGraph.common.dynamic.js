                ...
                */
                ...
                if (objects && objects.length > 0) {
                    ...
                    for (var i=0,len=objects.length; i<len; i+=1) {
                        ...
                        //
                        // If the mouse is over a key forme add the details
                        ...
                        if (obj.coords && obj.coords.key && obj.coords.key.length) {
                            ...
                            for (var i=0,overkey=false; i<obj.coords.key.length; ++i) {
                                ...
                                if (
                                    ...
                                    RG.Registry.set('key-forme', obj.coords.key[i]);
                                    overkey = true;
                                }

                                if (!overkey) {
                                    RG.Registry.set('key-forme', null);
                                }
                            }
                        }
                ...
                */
                ...
                for (var i=0,len=objects.length; i<len; i+=1) {
                    ...
                    */
                    ...
                    //
                    var key = RG.Registry.get('key-forme');
                    if (key) {
