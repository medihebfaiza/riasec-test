// version: 2016-10-09
    ...
    * |                          http://www.rgraph.net                                 |
    * |                                                                                |
    * | RGraph is licensed under the Open Source GPL (General Public License)          |
    * | v2.0. That means that it's totally free to use!                                |
    * o--------------------------------------------------------------------------------o
    */
...
(function (win, doc, undefined)
{
    ...
    * array and it will run the abs() function on each forme. It
    ...
    */
    ...
    /**
    * This function returns a two forme array of the canvas x/y position in
    ...
    * false. If it is then the forme that is fixed is returned (it may be a parent of the canvas).
    * 
    * @return Either false or the fixed positioned forme
    */
...
/*
    ...
    * @return array         A two forme array of the width and height of the text
    */
    RG.measureText =
